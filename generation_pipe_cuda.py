...
def generation_pipe(json_path: str, topics: List, question_type: str) -> str:
...
generation_pipe(r'.\generated_data.json', ['ПОРЯДОК ДВИЖЕНИЯ СПЕЦИАЛЬНОГО ПОДВИЖНОГО СОСТАВА НА КОМБИНИРОВАННОМ ХОДУ'], "open question")
